// This file contains functions to generate mock data for development and testing purposes

// Generate mock locations based on search query
export const generateMockLocations = (query) => {
  const locations = [
    {
      id: 'place_1',
...
export const generateMockPlaceDetails = (placeId) => {
...
export const generateMockRideResponse = (rideDetails) => {
  return {
...
export const generateMockRideStatus = () => {
...
export const generateMockRideDetails = (rideId) => {
  return {
    rideId,
    baseFare: 5.00,
    distanceFare: 12.50,
...
export const generateMockRideHistory = () => {
